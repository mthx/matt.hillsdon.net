...
The workflows use global parameters, S3 for input artifacts and makes heavy use
of artifact passing. Otherwise we just use the core container and steps template
features.

The experience was very positive, particularly considering the early stage of
the Argo project. We went looking for Kubernetes CI/workflow tooling,
